...
def evaluate(model, path, iou_thres, conf_thres, nms_thres, img_size, batch_size):
    ...
    dataloader = torch.utils.data.DataLoader(
        ...
        shuffle=False,
        num_workers=1, #因为train要用，就先默认设为1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_config", type=str, default="... .data", help="待检测图像路径")
    ...
    parser.add_argument("--iou_thres", type=float, default=0.5, help="符合检测条件所需的iou阈值")
